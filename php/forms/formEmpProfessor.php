...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $professoresId = $_POST['professores'];
    ...
    if ($quantidadeLivro > 0) {
        $sqlEmprestimo = "INSERT INTO emprestimo (id_usuario, id_livro, data_emprestimo, data_devolucao) VALUES ('$professoresId', '$livrosId', '$dataAtual', '$dataDevolucao')";
