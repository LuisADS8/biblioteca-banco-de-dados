...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($quantidadeLivro > 0) {
        $sqlEmprestimo = "INSERT INTO emprestimo (id_usuario, id_livro, data_emprestimo, data_devolucao) VALUES ('$alunosId', '$livrosId', '$dataAtual', '$dataDevolucao')";
